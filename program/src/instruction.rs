...
pub enum SoulburnInstruction {
    ...
    #[account(3, writable, name="mint", desc = "The mint of the spl-token (seeds: ['soulburn', 'mint', burn_event])")]
    #[account(4, name="token_program", desc = "The spl-token program")]
    #[account(5, name="system_program", desc = "The system program")]
    CreateBurnEvent { burns_required: u8, tokens_per_event_burn: u64, ends_at: Option<i64>, max_tokens: Option<u64> },
    ...
    #[account(5, writable, name="mint", desc = "The mint of the event (seeds: ['soulburn', 'mint', burn_event])")]
    #[account(6, writable, name="ata", desc = "The ata to receive the reward mint")]
